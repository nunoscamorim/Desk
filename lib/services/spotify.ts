...
export interface SpotifyService { getNowPlaying(): Promise<SpotifyNowPlaying | null>; getRecentlyPlayed(): Promise<SpotifyRecentTrack[]>; controlPlayback(action: SpotifyPlaybackAction, value?: SpotifyPlaybackValue): Promise<void>; }
