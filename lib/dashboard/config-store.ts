...
export async function getDashboardConfig(): Promise<DashboardConfig> {
  try {
    ...
    return { widgets: Array.isArray(parsed.widgets) ? parsed.widgets : defaultConfig.widgets, accentColor: typeof parsed.accentColor === "string" ? parsed.accentColor : defaultConfig.accentColor, fontFamily: typeof parsed.fontFamily === "string" ? parsed.fontFamily : defaultConfig.fontFamily };
