...
export function SpotifyWidget({ nowPlaying, expanded = false }: { nowPlaying: SpotifyNowPlaying | null; expanded?: boolean }) {
  ...
  </> : <><SpotifyLabel /><div className="empty-state">Spotify is quiet.</div></>}</article>;
}
