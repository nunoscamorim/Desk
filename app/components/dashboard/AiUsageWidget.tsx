...
export function AiUsageWidget({ codex, claudeCode, opencode }: { codex: AiUsage; claudeCode: AiUsage; opencode: AiUsage }) {
  return <article className="card usage-card"><div className="card-title-row"><h2>AI usage</h2></div><UsageMeter label="Codex" usage={codex} /><UsageMeter label="Claude Code" usage={claudeCode} /><UsageMeter label="Opencode" usage={opencode} /></article>;
}
