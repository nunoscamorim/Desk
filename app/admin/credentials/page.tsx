...
export default function CredentialsPage() {
  ...
  return <main className="admin-shell auth-shell"><section className="credentials-page"><Link className="admin-back" href="/admin">← Back to admin</Link><CredentialsPanel /></section></main>;
}
