...
const templates: Array<{ label: string; draft: Partial<HabitDraft> }> = [
  { label: "Medication", draft: { name: "Take medication", icon: "pill", color: "#ff8f6b", category: "medication", days: [0, 1, 2, 3, 4, 5, 6], time: "08:00", windowAfterMinutes: 60 } },
  { label: "Stretch", draft: { name: "Stretch", icon: "stretch", color: "#c9ff52", category: "movement", days: [1, 2, 3, 4, 5], time: "07:30", estimatedDurationMinutes: 5, steps: [{ id: "stretch-step", type: "check", title: "Complete a short stretch" }] } },
  { label: "Focus block", draft: { name: "Focus block", icon: "focus", color: "#7aa7ff", category: "focus", days: [1, 2, 3, 4, 5], time: "10:00", windowBeforeMinutes: 30, windowAfterMinutes: 120, estimatedDurationMinutes: 25, steps: [{ id: "focus-step", type: "focus", title: "Complete a focus session", targetMinutes: 25 }] } },
  { label: "Deep work", draft: { name: "Deep work", icon: "focus", color: "#5b8cff", category: "focus", days: [1, 2, 3, 4, 5], time: "14:00", windowAfterMinutes: 180, estimatedDurationMinutes: 45, steps: [{ id: "deep-work-step", type: "focus", title: "One focused task", targetMinutes: 45 }] } },
  { label: "Hydrate", draft: { name: "Hydrate", icon: "water", color: "#6bc8ff", category: "self-care", days: [0, 1, 2, 3, 4, 5, 6], time: "11:00", windowAfterMinutes: 1440, estimatedDurationMinutes: 5, steps: [{ id: "water-step", type: "check", title: "Finish a full glass of water" }] } },
  { label: "Walk", draft: { name: "Afternoon walk", icon: "stretch", color: "#2dd4bf", category: "movement", days: [0, 1, 2, 3, 4, 5, 6], time: "16:00", windowAfterMinutes: 180, estimatedDurationMinutes: 20, steps: [{ id: "walk-step", type: "check", title: "Go for a walk" }] } },
  { label: "Workout", draft: { name: "Workout", icon: "workout", color: "#ffb454", category: "workout", days: [1, 3, 5], time: "17:30", windowBeforeMinutes: 60, windowAfterMinutes: 240, estimatedDurationMinutes: 45, steps: [{ id: "workout-warmup", type: "check", title: "Warm up" }, { id: "workout-main", type: "focus", title: "Main lift", targetMinutes: 30 }, { id: "workout-cool", type: "check", title: "Cooldown" }] } },
  { label: "Morning routine", draft: { name: "Morning routine", icon: "sun", color: "#ffd166", category: "morning", days: [0, 1, 2, 3, 4, 5, 6], time: "07:00", windowAfterMinutes: 90, estimatedDurationMinutes: 15, steps: [{ id: "morning-step", type: "check", title: "Complete your morning routine" }] } },
  { label: "Evening reset", draft: { name: "Evening reset", icon: "moon", color: "#b78bff", category: "evening", days: [0, 1, 2, 3, 4, 5, 6], time: "19:00", windowAfterMinutes: 120, estimatedDurationMinutes: 10, steps: [{ id: "review", type: "check", title: "Review tomorrow" }, { id: "clear", type: "check", title: "Clear the desk" }] } },
  { label: "Reading", draft: { name: "Read a few pages", icon: "check", color: "#34d399", category: "custom", days: [0, 1, 2, 3, 4, 5, 6], time: "21:00", windowAfterMinutes: 120, estimatedDurationMinutes: 15, steps: [{ id: "reading-step", type: "check", title: "Read at least ten pages" }] } },
];
